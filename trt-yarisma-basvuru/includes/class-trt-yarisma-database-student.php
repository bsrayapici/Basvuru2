<?php
/**
 * Öğrenci Yarışması Veritabanı işlemleri sınıfı
 */
...
class TRT_Yarisma_Database_Student {
    ...
    public function __construct() {
        global $wpdb;
        $this->table_submissions = $wpdb->prefix . 'trt_student_submissions';
        $this->table_directors = $wpdb->prefix . 'trt_student_directors';
        $this->table_additional_info = $wpdb->prefix . 'trt_student_additional_info';
        $this->table_person_roles = $wpdb->prefix . 'trt_student_person_roles';
    }
    ...
    public function create_tables() {
        ...
        $sql1 = "CREATE TABLE {$this->table_submissions} (
            ...
            biography text,
            filmography text,
            student_document_path varchar(500),
    ...
    public function save_submission($data) {
        ...
        try {
            ...
            $submission_data = array(
                ...
                'student_document_path' => $data['student_document_path'],
            ...
            $wpdb->query('ROLLBACK');
            error_log('TRT Student Submission Error: ' . $e->getMessage());
            return false;
        }
    }
...
new TRT_Yarisma_Database_Student();
